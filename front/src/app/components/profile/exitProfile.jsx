...
export default function ExitProfile({ name = "Seu Nome", postCount = 0 }) {
    ...
    return (
        <div className="w-full h-[53px] px-[16px] flex items-center gap-[30px] sticky inset-0 bg-black/60 backdrop-blur-sm z-50 top-0 left-0">
            ...
            <div className="flex flex-col">
                <h1 className="text-[#E7E9EA] text-[20px] font-bold">{name}</h1>
      <span className="text-[13px] text-[#71767b]">{postCount} posts</span>
            </div>
        </div>
    );
}